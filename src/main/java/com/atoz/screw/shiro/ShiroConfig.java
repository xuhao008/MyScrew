...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        //登录成功默认跳转路径，不配置则跳转至”/”
        //shiroFilterFactoryBean.setSuccessUrl("/login/200");
        ...
        filterChainDefinitionMap.put("/interface-ui/**","anon");
        filterChainDefinitionMap.put("/demo2","anon");
    ...
    public SecurityManager securityManager() {
        ...
        defaultSecurityManager.setRealm(systemAuthorizingRealm());
