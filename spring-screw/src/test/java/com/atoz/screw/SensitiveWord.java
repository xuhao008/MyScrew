...
public class SensitiveWord {  
    ...
    {  
        ...
        try {  
            ...
            File file = new File("E:\\网站敏感词检测\\SensitiveWord-匹配度高，速度快\\CensorWords.txt");    //读取文件
    ...
    public static void main(String[] args){
	    ...
	    String str = "太多的伤bignews yuming感情怀也许只局限于饲养基地 荧幕中的情节，主人公尝试着去用某种方式渐渐的很潇洒地释自杀指南怀那些自己经历的伤感。"
